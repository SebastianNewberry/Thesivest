...
export const TIME_RANGES = ["1M", "3M", "6M", "YTD", "1Y", "2Y"] as const;
...
// Ticker symbols for individual stocks (for real data fetching)
...
export const PORTFOLIOS = [
  {
    id: "thesivest",
    name: "Your Investing Portfolio",
    color: "var(--color-primary)",
    acronym: "YP",
    stats: { beta: 1.12, alpha: "+5.4%", return: "+24.8%" },
  },
  {
    id: "berkshire",
    ...
    color: "#3b82f6",
    acronym: "BRK",
    stats: { beta: 0.88, alpha: "+2.1%", return: "+15.2%" },
  }, // blue-500
  {
    id: "pershing",
    ...
    color: "#64748b",
    acronym: "PS",
    stats: { beta: 1.05, alpha: "+1.8%", return: "+12.4%" },
  }, // slate-500
  // { id: 'bridgewater', name: 'Bridgewater', color: '#ef4444', acronym: 'BW' }, // red-500
  {
    ...
    color: "#14b8a6",
    acronym: "TP",
    stats: { beta: 0.95, alpha: "+0.5%", return: "+9.8%" },
  },
  {
    id: "ark",
    name: "ARK Invest",
    color: "#d946ef",
    acronym: "AR",
    stats: { beta: 1.55, alpha: "-4.2%", return: "-12.5%" },
  }, // fuchsia-500
  {
    id: "renaissance",
    name: "Renaissance",
    color: "#8b5cf6",
    acronym: "RT",
    stats: { beta: 0.92, alpha: "+8.4%", return: "+28.1%" },
  },
] as const;

// Map portfolio IDs to their ticker symbols
export const PORTFOLIO_TICKERS: Record<string, string> = {
  thesivest: "SPY", // Use S&P 500 as proxy for user portfolio
  berkshire: "BRK-B",
  pershing: "QQQ", // Use NASDAQ as proxy (Pershing not publicly traded)
  thirdpoint: "IWM", // Use Russell 2000 as proxy (Third Point not publicly traded)
  ark: "ARKK",
  renaissance: "QQQ", // Use NASDAQ as proxy (Renaissance not publicly traded)
};

// --- Global Benchmark Generation ---
const GENERATE_BENCHMARKS = (
  points: number,
...
const MASTER_BENCHMARKS = GENERATE_BENCHMARKS(730, 1440); // 2 Years

// --- Portfolio Data Generation ---
const GENERATE_PORTFOLIO_DATA = (
  benchmarks: any[],
  bias: number = 0.0005,
