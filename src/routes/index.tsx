  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary/30 overflow-x-hidden">
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto ">
        ...
        <div className="bg-background text-foreground font-sans selection:bg-primary/30 overflow-x-hidden">
          <div className="relative z-10 max-w-[1800px] mx-auto px-6 py-4">
            {/* Hero Section */}
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-12 items-center w-full my-24">
              ...
              <div className="flex flex-col items-center justify-center w-full">
                ...
                <div className="relative h-20 md:h-32 text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter flex items-center justify-center overflow-hidden w-full m-auto select-none">
                  <div className="inline-flex items-center hover:text-primary/80 transition-colors relative z-10">
                    <motion.div
